<script setup>
  import { getSunTime } from '../constans/export'
  import { getPressure } from '../constans/export'
                ...
                <div class="states">
                  <div class="state">
                    ...
                    <div class="state-time">
                      {{ getSunTime(weatherInfo?.sys?.sunrise, weatherInfo?.timezone) }}
                    </div>
                  </div>
                  <div class="state">
                    ...
                    <div class="state-time">
                      {{ getSunTime(weatherInfo?.sys?.sunset, weatherInfo?.timezone) }}
                    </div>
                  </div>
                </div>
              </div>
